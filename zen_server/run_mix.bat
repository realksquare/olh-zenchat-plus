...
set "ERTS_BIN=D:\erlang\erts-16.4\bin\"
set "PATH=D:\erlang\erts-16.4\bin;D:\erlang\bin;D:\elixir-install\elixir28\bin;%PATH%"
...
cd /d "D:\ZenChat+\zen_server"
echo.
echo Starting Phoenix server on http://localhost:4000
echo Press Ctrl+C to stop.
echo.
"D:\elixir-install\elixir28\bin\elixir.bat" "D:\elixir-install\elixir28\bin\mix" phx.server
pause
